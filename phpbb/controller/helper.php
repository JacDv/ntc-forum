	...
	*/
	...
	public function display_footer($run_cron = true)
	{
		...
		$this->template->assign_vars([
				...
				'CREDIT_LINE'			=> $this->language->lang('2025 &copy; Norwegian Training Center - Manila of the Norwegian Maritime Foundation of the Philippines Inc., All rights reserved.'),
