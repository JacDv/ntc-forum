...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            ...
            'console.command.user.delete_id' => 'getConsole_Command_User_DeleteIdService',
            ...
            'hifikabin.hidenewestuser.listener' => 'getHifikabin_Hidenewestuser_ListenerService',
            ...
            'phpbb.ucp.controller.delete_cookies' => 'getPhpbb_Ucp_Controller_DeleteCookiesService',
        ...
        $this->privates = [
            ...
            'console.command.user.delete_id' => true,
            ...
            'hifikabin.hidenewestuser.listener' => true,
            'hook_finder' => true,
            'http_kernel' => true,
            ...
            'phpbb.ucp.controller.delete_cookies' => true,
    ...
    {
        return $this->services['config'] = new \phpbb\config\db(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'forum_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forum_config_text');
    }
    ...
    /**
     * Gets the private 'console.command.user.delete_id' shared service.
     *
     * @return \phpbb\console\command\user\delete_id
     */
    ...
    protected function getConsole_CommandCollectionService()
    {
        ...
        $instance->add('console.command.user.delete_id');
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('forum_captcha_questions', 'forum_captcha_answers', 'forum_qa_confirm');
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addListener('core.page_header', [0 => function () {
            return ${($_ = isset($this->services['hifikabin.hidenewestuser.listener']) ? $this->services['hifikabin.hidenewestuser.listener'] : $this->getHifikabin_Hidenewestuser_ListenerService()) && false ?: '_'};
        }, 1 => 'add_page_header_link'], 0);
        $instance->addListener('core.page_header_after', [0 => function () {
            return ${($_ = isset($this->services['hifikabin.hidenewestuser.listener']) ? $this->services['hifikabin.hidenewestuser.listener'] : $this->getHifikabin_Hidenewestuser_ListenerService()) && false ?: '_'};
        }, 1 => 'header_hidenewestuser'], 0);
    ...
    /**
     * Gets the private 'hifikabin.hidenewestuser.listener' shared service.
     *
     * @return \hifikabin\hidenewestuser\event\listener
     */
    protected function getHifikabin_Hidenewestuser_ListenerService()
    {
        return $this->services['hifikabin.hidenewestuser.listener'] = new \hifikabin\hidenewestuser\event\listener(${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'});
    }
    ...
    /**
     * Gets the private 'phpbb.ucp.controller.delete_cookies' shared service.
     *
     * @return \phpbb\ucp\controller\delete_cookies
     */
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forum_profile_fields_lang');
    }
    ...
    {
        return new \stevotvr\flair\entity\category(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forum_flair_cats');
    }
    ...
    {
        $instance = new \stevotvr\flair\entity\flair(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forum_flair');
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forum_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forum_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forum_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forum_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_option'] = $instance = new \phpbb\textreparser\plugins\poll_option(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forum_poll_options');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forum_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forum_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'forum_users');
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'tables.acl_roles_data' => 'forum_acl_roles_data',
            'tables.acl_users' => 'forum_acl_users',
            'tables.attachments' => 'forum_attachments',
            'tables.auth_provider_oauth_token_storage' => 'forum_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'forum_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'forum_oauth_accounts',
            'tables.banlist' => 'forum_banlist',
            'tables.bbcodes' => 'forum_bbcodes',
            'tables.bookmarks' => 'forum_bookmarks',
            'tables.bots' => 'forum_bots',
            'tables.captcha_qa_questions' => 'forum_captcha_questions',
            'tables.captcha_qa_answers' => 'forum_captcha_answers',
            'tables.captcha_qa_confirm' => 'forum_qa_confirm',
            'tables.config' => 'forum_config',
            'tables.config_text' => 'forum_config_text',
            'tables.confirm' => 'forum_confirm',
            'tables.disallow' => 'forum_disallow',
            'tables.drafts' => 'forum_drafts',
            'tables.ext' => 'forum_ext',
            'tables.extensions' => 'forum_extensions',
            'tables.extension_groups' => 'forum_extension_groups',
            'tables.forums' => 'forum_forums',
            'tables.forums_access' => 'forum_forums_access',
            'tables.forums_track' => 'forum_forums_track',
            'tables.forums_watch' => 'forum_forums_watch',
            'tables.groups' => 'forum_groups',
            'tables.icons' => 'forum_icons',
            'tables.lang' => 'forum_lang',
            'tables.log' => 'forum_log',
            'tables.login_attempts' => 'forum_login_attempts',
            'tables.migrations' => 'forum_migrations',
            'tables.moderator_cache' => 'forum_moderator_cache',
            'tables.modules' => 'forum_modules',
            'tables.notification_emails' => 'forum_notification_emails',
            'tables.notification_types' => 'forum_notification_types',
            'tables.notifications' => 'forum_notifications',
            'tables.poll_options' => 'forum_poll_options',
            'tables.poll_votes' => 'forum_poll_votes',
            'tables.posts' => 'forum_posts',
            'tables.privmsgs' => 'forum_privmsgs',
            'tables.privmsgs_folder' => 'forum_privmsgs_folder',
            'tables.privmsgs_rules' => 'forum_privmsgs_rules',
            'tables.privmsgs_to' => 'forum_privmsgs_to',
            'tables.profile_fields' => 'forum_profile_fields',
            'tables.profile_fields_data' => 'forum_profile_fields_data',
            'tables.profile_fields_options_language' => 'forum_profile_fields_lang',
            'tables.profile_fields_language' => 'forum_profile_lang',
            'tables.ranks' => 'forum_ranks',
            'tables.reports' => 'forum_reports',
            'tables.reports_reasons' => 'forum_reports_reasons',
            'tables.search_results' => 'forum_search_results',
            'tables.search_wordlist' => 'forum_search_wordlist',
            'tables.search_wordmatch' => 'forum_search_wordmatch',
            'tables.sessions' => 'forum_sessions',
            'tables.sessions_keys' => 'forum_sessions_keys',
            'tables.sitelist' => 'forum_sitelist',
            'tables.smilies' => 'forum_smilies',
            'tables.sphinx' => 'forum_sphinx',
            'tables.styles' => 'forum_styles',
            'tables.styles_template' => 'forum_styles_template',
            'tables.styles_template_data' => 'forum_styles_template_data',
            'tables.styles_theme' => 'forum_styles_theme',
            'tables.styles_imageset' => 'forum_styles_imageset',
            'tables.styles_imageset_data' => 'forum_styles_imageset_data',
            'tables.teampage' => 'forum_teampage',
            'tables.topics' => 'forum_topics',
            'tables.topics_posted' => 'forum_topics_posted',
            'tables.topics_track' => 'forum_topics_track',
            'tables.topics_watch' => 'forum_topics_watch',
            'tables.user_group' => 'forum_user_group',
            'tables.user_notifications' => 'forum_user_notifications',
            'tables.users' => 'forum_users',
            'tables.warnings' => 'forum_warnings',
            'tables.words' => 'forum_words',
            'tables.zebra' => 'forum_zebra',
            ...
            'tables.thanks' => 'forum_thanks',
            'stevotvr.flair.tables.flair' => 'forum_flair',
            'stevotvr.flair.tables.flair_categories' => 'forum_flair_cats',
            'stevotvr.flair.tables.flair_favorites' => 'forum_flair_favs',
            'stevotvr.flair.tables.flair_groups' => 'forum_flair_groups',
            'stevotvr.flair.tables.flair_notifications' => 'forum_flair_notif',
            'stevotvr.flair.tables.flair_triggers' => 'forum_flair_triggers',
            'stevotvr.flair.tables.flair_users' => 'forum_flair_users',
            ...
            'tables' => [
                ...
                'acl_roles' => 'forum_acl_roles',
                'acl_roles_data' => 'forum_acl_roles_data',
                'acl_users' => 'forum_acl_users',
                'attachments' => 'forum_attachments',
                'auth_provider_oauth_token_storage' => 'forum_oauth_tokens',
                'auth_provider_oauth_states' => 'forum_oauth_states',
                'auth_provider_oauth_account_assoc' => 'forum_oauth_accounts',
                'banlist' => 'forum_banlist',
                'bbcodes' => 'forum_bbcodes',
                'bookmarks' => 'forum_bookmarks',
                'bots' => 'forum_bots',
                'captcha_qa_questions' => 'forum_captcha_questions',
                'captcha_qa_answers' => 'forum_captcha_answers',
                'captcha_qa_confirm' => 'forum_qa_confirm',
                'config' => 'forum_config',
                'config_text' => 'forum_config_text',
                'confirm' => 'forum_confirm',
                'disallow' => 'forum_disallow',
                'drafts' => 'forum_drafts',
                'ext' => 'forum_ext',
                'extensions' => 'forum_extensions',
                'extension_groups' => 'forum_extension_groups',
                'forums' => 'forum_forums',
                'forums_access' => 'forum_forums_access',
                'forums_track' => 'forum_forums_track',
                'forums_watch' => 'forum_forums_watch',
                'groups' => 'forum_groups',
                'icons' => 'forum_icons',
                'lang' => 'forum_lang',
                'log' => 'forum_log',
                'login_attempts' => 'forum_login_attempts',
                'migrations' => 'forum_migrations',
                'moderator_cache' => 'forum_moderator_cache',
                'modules' => 'forum_modules',
                'notification_emails' => 'forum_notification_emails',
                'notification_types' => 'forum_notification_types',
                'notifications' => 'forum_notifications',
                'poll_options' => 'forum_poll_options',
                'poll_votes' => 'forum_poll_votes',
                'posts' => 'forum_posts',
                'privmsgs' => 'forum_privmsgs',
                'privmsgs_folder' => 'forum_privmsgs_folder',
                'privmsgs_rules' => 'forum_privmsgs_rules',
                'privmsgs_to' => 'forum_privmsgs_to',
                'profile_fields' => 'forum_profile_fields',
                'profile_fields_data' => 'forum_profile_fields_data',
                'profile_fields_options_language' => 'forum_profile_fields_lang',
                'profile_fields_language' => 'forum_profile_lang',
                'ranks' => 'forum_ranks',
                'reports' => 'forum_reports',
                'reports_reasons' => 'forum_reports_reasons',
                'search_results' => 'forum_search_results',
                'search_wordlist' => 'forum_search_wordlist',
                'search_wordmatch' => 'forum_search_wordmatch',
                'sessions' => 'forum_sessions',
                'sessions_keys' => 'forum_sessions_keys',
                'sitelist' => 'forum_sitelist',
                'smilies' => 'forum_smilies',
                'sphinx' => 'forum_sphinx',
                'styles' => 'forum_styles',
                'styles_template' => 'forum_styles_template',
                'styles_template_data' => 'forum_styles_template_data',
                'styles_theme' => 'forum_styles_theme',
                'styles_imageset' => 'forum_styles_imageset',
                'styles_imageset_data' => 'forum_styles_imageset_data',
                'teampage' => 'forum_teampage',
                'topics' => 'forum_topics',
                'topics_posted' => 'forum_topics_posted',
                'topics_track' => 'forum_topics_track',
                'topics_watch' => 'forum_topics_watch',
                'user_group' => 'forum_user_group',
                'user_notifications' => 'forum_user_notifications',
                'users' => 'forum_users',
                'warnings' => 'forum_warnings',
                'words' => 'forum_words',
                'zebra' => 'forum_zebra',
                'thanks' => 'forum_thanks',
                'flair' => 'forum_flair',
                'flair_categories' => 'forum_flair_cats',
                'flair_favorites' => 'forum_flair_favs',
                'flair_groups' => 'forum_flair_groups',
                'flair_notifications' => 'forum_flair_notif',
                'flair_triggers' => 'forum_flair_triggers',
                'flair_users' => 'forum_flair_users',
            ],
            'core.adm_relative_path' => 'adm/',
            'core.table_prefix' => 'forum_',
